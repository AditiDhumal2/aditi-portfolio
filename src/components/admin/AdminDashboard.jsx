...
const AdminDashboard = () => {
  ...
  const fetchAllData = async () => {
    try {
      const [profileRes, projectsRes, currentProjectsRes, researchRes, certsRes, achievementsRes, contactRes] = await Promise.all([
        axios.get('/api/profile'),
        axios.get('/api/projects'),
        // REMOVED: axios.get('/api/experience'),
      ...
      // REMOVED: setExperience(experienceRes.data);
  ...
  // Updated tabs - Removed Experience
  const tabs = [
    { id: 'about', name: '📝 About / Profile', component: AboutTab },
    // REMOVED: { id: 'experience', name: '💼 Experience', component: ExperienceTab },
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        {ActiveComponent && (
          <ActiveComponent
            ...
            // REMOVED: experience={experience}
            // REMOVED: setExperience={setExperience}
