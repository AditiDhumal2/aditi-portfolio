  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Certificate Image Section with View Button */}
          <div className="relative h-64 bg-gradient-to-r from-accent/10 to-purple-500/10 rounded-t-2xl overflow-hidden">
            {cert.image && cert.image !== "" ? (
              <>
                ...
                <button
                  ...
                  className="absolute bottom-4 right-4 bg-black/70 hover:bg-accent text-white px-3 py-2 rounded-lg text-sm flex items-center gap-2 transition z-10"
                >
          ...
          <div className="p-6">
            <div className="flex items-start justify-between mb-4 flex-wrap gap-3">
              ...
              {cert.link && cert.link !== "#" && (
                <a href={cert.link} target="_blank" rel="noopener noreferrer" className="bg-accent hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition flex items-center gap-2">
                  🔗 View Course
                </a>
              )}
            </div>
